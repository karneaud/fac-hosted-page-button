...
<form method="GET" class="fac_hosted_page_button payment_link" id="fac_hosted_page_button_form" action="<?php print  esc_attr($fac_hosted_page_url) ?>">
	<button type="submit" form="fac_hosted_page_button_form" value="Submit" class="wp_fac_hosted_button_page payment_button">
    <?php print esc_html($text) ?></button>
</form>
